...
<template>
  <div class="moradi">
    ...
    <section id="recursos" class="m-section">
      <div class="m-wrap">
    ...
    <section class="m-section alt">
      <div class="m-wrap">
        <h2>Como funciona</h2>
        <div class="m-steps">
          <div v-for="s in steps" :key="s.n" class="m-step">
            <span class="m-num">{{ s.n }}</span>
            <h3>{{ s.t }}</h3>
            <p>{{ s.d }}</p>
          </div>
        </div>
    ...
    <footer class="m-foot">
      <div class="m-wrap m-foot-in">
        <span class="m-logo sm">moradi<span>.</span></span>
        <span>
