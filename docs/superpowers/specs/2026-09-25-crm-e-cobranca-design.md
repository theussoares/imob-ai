...
| Estorno do provedor **cancela o repasse pendente** daquela cobrança; repasse já pago fica, vai para o log (`cobranca.estorno_com_repasse_pago`) e a ficha do contrato avisa o valor repassado a mais (`repassesAMaior`, derivado de recebido × repassado, não gravado) | deixar o repasse de pé e confiar que alguém confira o extrato | a imobiliária transferiria ao proprietário um dinheiro que já voltou ao inquilino. O repasse pago não se desfaz por código: a transferência foi manual (B3.8), e reaver é conversa com o proprietário |
